...
userRoute.get("/:userId", user_controller_1.userController.getSingleUser);
userRoute.put("/:userId", user_controller_1.userController.updateUser);
userRoute.delete("/:userId", user_controller_1.userController.deleteUser);
